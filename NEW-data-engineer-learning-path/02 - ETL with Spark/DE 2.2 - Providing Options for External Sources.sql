...
select "${DA.paths.sales_csv}" as csvFileLocation

-- COMMAND ----------

-- MAGIC %python
-- MAGIC dbutils.fs.ls('dbfs:/mnt/dbacademy-users/richard.tennant@stonex.com/data-engineer-learning-path')
...
LOCATION "dbfs:/mnt/dbacademy-users/richard.tennant@stonex.com/data-engineer-learning-path/sales-csv"

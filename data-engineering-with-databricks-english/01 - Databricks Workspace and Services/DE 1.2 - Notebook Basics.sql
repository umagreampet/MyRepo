...
-- MAGIC        current_date() as CurrentDate,
-- MAGIC        current_timestamp() as CurrentDateTime,
-- MAGIC        from_utc_timestamp('2021-10-06T15:37:07.425+0000', 'Asia/Seoul') AS UTCConversionToLocal; 
...
-- MAGIC # dbutils.fs.cp("/databricks-datasets/Rdatasets/data-001/csv/ggplot2/economics.csv", "/tmp/new/mycopy_economics.txt")
-- MAGIC dbutils.fs.help("cp")
-- MAGIC #dbutils.fs.cp("/databricks-datasets/Rdatasets/data-001/csv/ggplot2/*", "/tmp/new/*")
-- MAGIC #dbutils.fs.ls('/tmp/new')
-- MAGIC
